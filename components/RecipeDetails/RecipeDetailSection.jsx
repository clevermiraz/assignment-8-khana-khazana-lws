                ...
                <div className="grid grid-cols-12 container gap-8 justify-items-center">
                    ...
                    <div className="col-span-12 md:col-span-6 py-8 flex flex-col justify-center">
                        ...
                        <p className="text-gray-600 text-sm my-6 leading-6">
                            Supermarket brands of ricotta contain stabilizers,
                            which can give the cheese a gummy texture when
                            baked. Check the label and choose ricotta made with
                ...
                <div className="container py-12">
                    ...
                    <div>
                        <div className="step">
                            <h3>Step 1</h3>
                            <p>
                                Labour, of evaluated would he the a the our what
                                is in the arduous sides behavioural is which the
                                have didn&apos;t kicked records the it framework
                                by the for traveler sure the can most well her.
                                Entered have break himself cheek, and activity,
                                for bit of text.
                            </p>
                        </div>
